...
function RequestDetails() {
    ...
    const approveHandler=()=>{
        navigate('/certificate/details/confirm/output')
    }
            ...
            <div className='body-wrapper'>
                ...
                <div className='body-container'>
                    ...
                    <div className='request-status-wrapper'>
                        {pending?<div className='status-wrapper' ><HelpOutlineIcon style={{color:"blue"}}/> <p className="status-dis" style={{color:"blue"}}>Click the check button to see the status!</p></div> :status?<div className='status-wrapper' ><CheckCircleOutlineIcon style={{color:"green"}}/> <p className="status-dis" style={{color:"green"}}>OK! Press "Approve" button to continue...</p></div>:<div className='status-wrapper' ><DoNotDisturbAltIcon style={{color:"red"}}/> <p className="status-dis" style={{color:"red"}}>This certificate is alredy issued!</p></div>}
                        {status && <div className='temp-select-dropDown'>Hi</div>}
                    </div>
                    <div className='request-action-btn-wrapper'>
                        {isChecked?<button className='approve-btn' onClick={approveHandler}>Approve</button>:<button className='check-btn' onClick={checkHandler}>Check</button>} <button className='reject-btn'>Reject</button>
                    </div>
