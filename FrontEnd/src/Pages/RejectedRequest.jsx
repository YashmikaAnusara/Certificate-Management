...
function RejectedRequest() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://${Port}:8070/request/reject/certificates/details`)
      .then((res) => {
        if (res.data) {
          setIsopen(false);
          setDetails(res.data);
      ...
      <div className="body-wrapper">
        ...
        <div className="body-container">
          ...
          <div className="rejected-request-status-wrapper clearfix">
            ...
            <div className="rejected-request-status">
          ...
          <div className="rejected-request-table-wrapper">
            <div className="rejected-request-table-header">
              <div id="rejected-request-body-col1">
                <center> Status</center>
              </div>
              <div id="rejected-request-body-col6">
                <center> ID</center>
              </div>
              <div id="rejected-request-body-col2">
                <center> NIC</center>
              </div>
              <div id="rejected-request-body-col3">
                <center> Name</center>
              </div>
              <div id="rejected-request-body-col4">
                <center> Submited Date</center>
              </div>
              <div id="rejected-request-body-col5">
                <center> Rejected Date</center>
              </div>
            </div>
...
function RejectedRequestTable(props) {
  ...
  return (
    <div className="rejected-request-table-body" onClick={rejectDetailsHandler}>
      <div className="rejected-request-body-col1">
        <center>
          {" "}
          <FiberManualRecordIcon fontSize="small" style={{ color: "red" }} />
        </center>
      </div>
      <div className="rejected-request-body-col6">
        <center> {props.id}</center>
      </div>
      <div className="rejected-request-body-col2">
        <center> {props.nic}</center>
      </div>
      <div className="rejected-request-body-col3">
        <center> {props.name}</center>
      </div>
      <div className="rejected-request-body-col4">
        <center> {props.s_date}</center>
      </div>
      <div className="rejected-request-body-col5">
        <center> {props.r_date}</center>
      </div>
    </div>
  );
}
